...
class FileUploadWorkItemSpec extends JsonFormatSpec[FileUploadWorkItem] {

  override def model: FileUploadWorkItem =
    FileUploadWorkItem(
  ...
  override implicit def format: OFormat[FileUploadWorkItem] = FileUploadWorkItem.format
}
