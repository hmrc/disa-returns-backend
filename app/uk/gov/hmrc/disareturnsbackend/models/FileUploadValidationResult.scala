...
final case class FileUploadValidationResult(
  rowsValidated: Long,
...
object FileUploadValidationResult {
  implicit val format: OFormat[FileUploadValidationResult] =
    Json.using[Json.WithDefaultValues].format[FileUploadValidationResult]
}
